...
install_singbox(){
    ...
    wget --no-check-certificate -O /etc/sing-box/config.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/server1-config.json
    
    mkdir /root/sing-box
    wget --no-check-certificate -O /root/sing-box/client1-sockshttp.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client1-sockshttp.json
    wget --no-check-certificate -O /root/sing-box/client2-sockshttp.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client2-sockshttp.json
    wget --no-check-certificate -O /root/sing-box/client3-sockshttp.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client3-sockshttp.json
    wget --no-check-certificate -O /root/sing-box/client4-sockshttp.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client4-sockshttp.json
    wget --no-check-certificate -O /root/sing-box/client5-sockshttp.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client5-sockshttp.json
    wget --no-check-certificate -O /root/sing-box/client1-tun.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client1-tun.json
    wget --no-check-certificate -O /root/sing-box/client2-tun.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client2-tun.json
    wget --no-check-certificate -O /root/sing-box/client3-tun.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client3-tun.json
    wget --no-check-certificate -O /root/sing-box/client4-tun.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client4-tun.json
    wget --no-check-certificate -O /root/sing-box/client5-tun.json https://raw.githubusercontent.com/lanhebe/singbox-shadowtls/main/configs/client5-tun.json
    ...
    sed -i "s/填写自定义密码/${ps2}/g" /root/sing-box/client3-sockshttp.json
    sed -i "s/填写自定义密码/${ps3}/g" /root/sing-box/client4-sockshttp.json
    sed -i "s/填写自定义密码/${ps4}/g" /root/sing-box/client5-sockshttp.json
    
    sed -i "s/填写自定义密码/${ps}/g" /root/sing-box/client1-tun.json
    sed -i "s/填写自定义密码/${ps1}/g" /root/sing-box/client2-tun.json
    sed -i "s/填写自定义密码/${ps2}/g" /root/sing-box/client3-tun.json
    sed -i "s/填写自定义密码/${ps3}/g" /root/sing-box/client4-tun.json
    sed -i "s/填写自定义密码/${ps4}/g" /root/sing-box/client5-tun.json
    ...
    if [[ -n $(service sing-box status 2>/dev/null | grep "inactive") ]]; then
        ...
        green "Sing-box 安装成功"
        yellow "客户端Socks / HTTP代理模式配置文件已保存到 /root/sing-box/client(1-5)-sockshttp.json 请自行根据用户数量进行分配下载到本地使用"
        yellow "客户端TUN模式配置文件已保存到 /root/sing-box/client(1-5)-tun.json 请自行根据用户数量进行分配下载到本地使用"
    fi
}
